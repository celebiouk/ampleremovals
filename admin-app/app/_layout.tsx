...
function RootNavigator() {
  ...
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="payroll/bulk-actions" />
      <Stack.Screen name="payroll/verification" />
      <Stack.Screen name="payroll/reconciliation" />
      <Stack.Screen name="payslip/[id]" />
      <Stack.Screen name="payslip/[id]/adjustments" />
      <Stack.Screen name="payslip/[id]/bank-details" />
      <Stack.Screen name="payslip/[id]/earnings" />
      <Stack.Screen name="payslips/index" />
      <Stack.Screen name="payslips/[id]" />
      <Stack.Screen name="payslips/settings" />
      <Stack.Screen name="payslips/earnings-summary" />
      <Stack.Screen name="payslips/payment-history" />
      ...
      <Stack.Screen name="payslips/earnings-analytics" />
