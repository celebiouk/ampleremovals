...
import { Calendar, DollarSign, Settings, TrendingUp, History, Calculator, FileText } from "lucide-react-native";
        ...
        <Animated.View entering={FadeInDown.springify()} style={{ marginBottom: spacing.lg, gap: spacing.md }}>
          ...
          <View style={{ flexDirection: "row", gap: spacing.md }}>
            ...
            <Pressable
              onPress={() => {
                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light).catch(() => {});
                router.push("/payslips/tax-documents");
              }}
              style={{
                flex: 1,
                paddingHorizontal: spacing.base,
            ...
            >
              <FileText size={18} color={colors.accent.DEFAULT} />
              <Text style={[type.body, { color: colors.accent.DEFAULT, fontWeight: "600" }]}>
                Documents
              </Text>
            </Pressable>
