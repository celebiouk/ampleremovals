...
const PAGE_SIZE = 20;
const IN_PROGRESS: BookingStatus[] = ["called","not_called","answered","not_answered","quote_sent","quote_confirmed","deposit_invoice_sent","deposit_paid_job_confirmed","full_invoice_sent","full_balance_paid"];
