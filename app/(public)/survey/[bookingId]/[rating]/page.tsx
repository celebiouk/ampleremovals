...
export default function SurveyPage() {
  ...
  // Submitted state — 5★ are instantly invited to a public Google review; 1–4★ stay
  // as private internal feedback for the team only.
  if (submitted) {
    if (rating === 5) {
      return (
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-50 to-white p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl">
            ...
            <p className="mt-4 text-lg text-slate-600">
              Thank you for the 5 stars! Would you share that on Google? It only takes a few
              seconds and helps other families find us.
            </p>
            <a
