...
export async function distanceMatrix(
  ...
  // Use duration_in_traffic when available (traffic-aware), else plain duration.
  // No padding is added — this is the same drive time Google/Apple Maps show, so
  // the ETA the driver and customer see matches what the driver sees navigating.
